...
const aleatorioTriangular = (min, max, moda) => {
    const a = min;
    const b = max;
    const c = moda;
    const u = Math.random();
...
const distribucionNormal = (media, desviacion) => {
    let u = 0, v = 0;
    while (u === 0)
        u = Math.random();
    while (v === 0)
...
class SimulationData {
    constructor(numeroSimulacion = 0) {
        this.dias = [];
...
var TipoDia;
(function (TipoDia) {
    TipoDia[TipoDia["lunes"] = 0] = "lunes";
    TipoDia[TipoDia["martes"] = 1] = "martes";
})(TipoDia || (TipoDia = {}));
class Dia {
    constructor(numeroDia = 0, numeroSimulacion = 0) {
    ...
    imprimirResumenDelDia() {
        ...
        console.table({
            'Tipo 1': {
                ...
                'Utilidad': this.periodicosVendidosTipo1 * periodicos.tipo1.ingreso_venta - this.periodicosAdquiridosTipo1 * periodicos.tipo1.costo_adquisicion - this.periodicosFaltantesTipo1 * periodicos.tipo1.costo_faltante + this.periodicosSobrantesTipo1 * periodicos.tipo1.ingreso_sobrante
            },
            'Tipo 2': {
                ...
                'Utilidad': this.periodicosVendidosTipo2 * periodicos.tipo2.ingreso_venta - this.periodicosAdquiridosTipo2 * periodicos.tipo2.costo_adquisicion - this.periodicosFaltantesTipo2 * periodicos.tipo2.costo_faltante + this.periodicosSobrantesTipo2 * periodicos.tipo2.ingreso_sobrante
            }
        });
...
let simulacionesDatosMuestraPiloto = [];
